 ...
 *   id = "ai_interpolator_openai_string",
 *   title = @Translation("OpenAI String"),
 *   field_rule = "string"
 * )
 */
class OpenAiString extends OpenAiBase implements AiInterpolatorFieldRuleInterface {

  /**
   * {@inheritDoc}
   */
  public $title = 'OpenAI String';
  ...
  public function generate(ContentEntityInterface $entity, FieldDefinitionInterface $fieldDefinition, array $interpolatorConfig) {
    ...
    foreach ($prompts as $prompt) {
      $prompt .= "\n\nDo not include any explanations, only provide a RFC8259 compliant JSON response following this format without deviation.\n[{\"value\": \"only string value requested\"}]";
      try {

 ...
 *   id = "ai_interpolator_openai_video_to_HTML",
 *   title = @Translation("OpenAI Video To HTML (Experimental)"),
 *   field_rule = "text_long"
 * )
 */
class OpenAiVideoToHtml extends OpenAiVideoHelper implements AiInterpolatorFieldRuleInterface {

  /**
   * {@inheritDoc}
   */
  public $title = 'OpenAI Video To HTML (Experimental)';
  ...
  public function extraFormFields(ContentEntityInterface $entity, FieldDefinitionInterface $fieldDefinition) {
    $form['interpolator_generating_prompt'] = [
      '#type' => 'textarea',
      ...
      '#default_value' => $fieldDefinition->getConfig($entity->bundle())->getThirdPartySetting('ai_interpolator', 'interpolator_generating_prompt', ''),
      '#weight' => 24,
    ];
  ...
  public function generate(ContentEntityInterface $entity, FieldDefinitionInterface $fieldDefinition, array $interpolatorConfig) {
    // Tokenize prompt.
    $cutPrompt = $this->renderTokenPrompt($interpolatorConfig['generating_prompt'], $entity);
